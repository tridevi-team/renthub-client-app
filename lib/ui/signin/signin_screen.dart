          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                TextInputWidget(hintText: 'Nhập mật khẩu',
                    isPassword: true,
                ...
                CustomElevatedButton(label: 'Đăng nhập', onTap: () {}, bgColor: const Color(0xFF4B7BE5), textColor: Colors.white),
                const SizedBox(height: 16),
                CustomElevatedButton(label: 'Tiếp tục với Google', iconPath: 'assets/icons/ic_google.svg', onTap: () {}, textColor: Colors.black.withOpacity(0.5)),
