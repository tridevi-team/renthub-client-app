                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text("${house.name}", textAlign: TextAlign.center, maxLines: 1, overflow: TextOverflow.ellipsis, style: ConstantFont.semiBoldText.copyWith(fontSize: 12, color: AppColors.white)),
                    ),
                  ],
                ),
              )
