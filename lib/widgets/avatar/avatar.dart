...
class AvatarWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String lastName = name.trim().isNotEmpty
        ? name.trim().split(' ').last
        : "";
    String displayChar = lastName.isNotEmpty ? lastName[0] : "?";
    return Container(
      height: height,
      width: width,
      ...
      decoration: BoxDecoration(
        ...
        color: getRandomColor(displayChar),
      ),
      child: Text(displayChar, style: ConstantFont.boldText.copyWith(color: AppColors.white, fontSize: 20)),
    );
  }
